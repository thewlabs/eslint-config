...
const isCwdInScope = isPackageExists('@thewlabs/eslint-config')
 ...
 * @example
 * ```ts
 * import { renameRules } from '@thewlabs/eslint-config'
 *
 * export default [{
 *   rules: renameRules(
 *     {
 ...
 * @example
 * ```ts
 * import { renamePluginInConfigs } from '@thewlabs/eslint-config'
